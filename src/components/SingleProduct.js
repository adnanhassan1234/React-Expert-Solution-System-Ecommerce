...
const SingleProduct = () => {
  const { id } = useParams();
  console.log("🚀 ~ file: SingleProduct.js:16 ~ SingleProduct ~ id:", id)
              ...
              <div className="full">
                <div className="product_data">
                  ...
                  <div className="product-color">
                     <b> <p>Color: {colour} </p></b>
                  </div>  
                  <div className="product_description">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias pariatur asperiores amet consequuntur suscipit similique eos in fugiat vitae unde aliquam, porro a quod fugit omnis quia enim voluptate odio.</p>
                  </div>
                  <div className="row">
